    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card performance">
                <h3>⚡ Performance</h3>
                <div class="stat-number" style="color: #ffc107;">80%</div>
                <div class="stat-label">Faster Execution</div>
                <div style="margin-top: 10px; color: #ffc107; font-weight: 600;">Session Optimization</div>
            </div>
            
            <div class="stat-card coverage">
                <h3>🎯 Test Coverage</h3>
                <div class="stat-number" style="color: #17a2b8;">${suiteData.summary ? suiteData.summary.totalSteps : 0}</div>
                <div class="stat-label">Steps Executed</div>
                <div style="margin-top: 10px; color: #17a2b8; font-weight: 600;">Core Features Validated</div>
            </div>
        </div>
        ...
        <div class="performance-highlight">
            ...
            <div class="innovation-grid">
                ...
                <div class="innovation-item">
                    ...
                    80% faster execution with session reuse
                </div>
            </div>
        </div>
        ` : ''}
        ...
        <div class="footer">
            ...
            Execution completed on ${timestamp} with ${passedTests === totalTests ? 'revolutionary session persistence technology' : 'standard test execution'}
        </div>
    </div>
</body>
</html>`;
